...
export default function SettingsPage() {
    ...
    const sections = [
        ...
        },
        {
            ...
            // Custom slider for border width
            customInput: (
        ...
        <div className="space-y-8">
            ...
            <div className="grid gap-8">
                ...
                {sections.map((section) => (
                    <div key={section.title} className="bg-white dark:bg-card-bg p-6 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200">{section.title} Settings</h2>
                ...
                {/* Alert Settings */}
                <div className="bg-white dark:bg-card-bg rounded-lg shadow-sm border border-gray-100 dark:border-gray-800">
